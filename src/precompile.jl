...
function _precompile_()
    ...
    for i in 0:3
        ...
        @enforce Base.precompile(Tuple{typeof(getindex), OffsetVertexIterator{i}, Int})
        ...
        @enforce Base.precompile(Tuple{typeof(keys),OffsetVertexIterator{i}})
        ...
        @enforce Base.precompile(Tuple{typeof(length), PeriodicGraphs.EdgeDict{i}})
        ...
        @enforce Base.precompile(Tuple{typeof(PeriodicGraphs.convert_to_ering!), Vector{Int}, Vector{PeriodicVertex{i}}, EdgeDict{i}, SVector{i,Int}, Int})
        @enforce Base.precompile(Tuple{typeof(PeriodicGraphs.convert_to_ering), Vector{PeriodicVertex{i}}, EdgeDict{i}, SVector{i,Int}, Int})
        ...
        @enforce Base.precompile(Tuple{typeof(getindex), RingIncluding{i}, Int})
        @enforce Base.precompile(Tuple{typeof(length), RingIncluding{i}})
        @enforce Base.precompile(Tuple{typeof(eltype), Type{RingIncluding{i}}})
        @enforce Base.precompile(Tuple{typeof(keys), RingIncluding{i}})
        ...
        @enforce Base.precompile(Tuple{typeof(keys), RingAttributions{i}})
    end
end
