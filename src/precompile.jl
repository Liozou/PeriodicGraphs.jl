...
function _precompile_()
    ...
    for i in 0:3
        ...
        @enforce Base.precompile(Tuple{typeof(PeriodicGraphs.isdirectedge), PeriodicEdge{i}})
        @enforce Base.precompile(Tuple{typeof(PeriodicGraphs.directedge), PeriodicEdge{i}})
        @enforce Base.precompile(Tuple{typeof(PeriodicGraphs.directedge), Int, Int, SVector{i,Int}})
        @enforce Base.precompile(Tuple{typeof(PeriodicGraphs.directedge), Int, Int, NTuple{i,Int}})
        @enforce Base.precompile(Tuple{typeof(PeriodicGraphs.directedge), PeriodicVertex{i}, PeriodicVertex{i}})
